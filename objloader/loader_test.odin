...
@(test)
load_simple_obj_with_normals :: proc(t: ^testing.T) {
	data := `v -0.5 -0.5 0
v 0.5 -0.5 0
v 0.5 0.5 0
v -0.5 0.5 0
...
`
	...
	expected := Obj {
		vertices = [dynamic]Vertex {
			{position = {-0.5, -0.5, 0}, tex_coords = {1, 0}, normal = {0, 1, 0}},
			{position = {0.5, -0.5, 0}, tex_coords = {0, 0}, normal = {0, 1, 0}},
			{position = {0.5, 0.5, 0}, tex_coords = {0, 1}, normal = {0, 1, 0}},
			{position = {-0.5, 0.5, 0}, tex_coords = {1, 1}, normal = {0, 1, 0}},
		},
		indices  = [dynamic]u32{0, 1, 2, 2, 3, 0},
	}
	defer destroy(expected)
